...
import (
	...
	"mazic/pocketbase/forms"
	"mazic/pocketbase/mails"
	"mazic/pocketbase/models"
	"mazic/pocketbase/models/schema"
	"mazic/pocketbase/tokens"
	"mazic/pocketbase/tools/cron"
	"mazic/pocketbase/tools/filesystem"
	"mazic/pocketbase/tools/hook"
	"mazic/pocketbase/tools/inflector"
	"mazic/pocketbase/tools/list"
	"mazic/pocketbase/tools/mailer"
	"mazic/pocketbase/tools/rest"
	"mazic/pocketbase/tools/security"
	"mazic/pocketbase/tools/subscriptions"
